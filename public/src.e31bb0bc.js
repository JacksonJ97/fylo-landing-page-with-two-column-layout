...
var heroTextInput = document.getElementById("hero-text-input");
var ctaTextInput = document.getElementById("cta-text-input");
var heroTextContainer = document.querySelector(".hero-input-container");
var heroTextInputContainer = document.querySelector(".hero-text-input-container");
var ctaInputContainer = document.querySelector(".cta-input-container");
var heroInputResultDiv = document.createElement("div");
